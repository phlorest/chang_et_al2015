...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_chang_et_al2015.py --with-zenodo --with-cldfreadme
  ```
...
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_chang_et_al2015.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_chang_et_al2015.py vX.Y
  ```
